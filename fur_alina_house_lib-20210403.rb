...
define :fur_alina_house_melody do | synth |
...
define :fur_alina_house do | fah_sleep, synth |
  
  use_bpm 120
  
  n_bg_repeat = 28 + (fah_sleep / 4).ceil
  
  fur_alina_house_background_sound n_bg_repeat
  
  sleep fah_sleep
  
  fur_alina_house_melody synth
